...
Семантика программы~-- фактическая связь исходных данных и результатов.

Спецификация программы~-- желаемое соотношение между исходными данными и результатами.

Корректность~-- соответствие семантики программы заданной спецификации.
\end{slide}

\begin{slide}
Формальная верификация программ: математический метод, позволяющий:
\begin{itemize}
\item Описать "<пучок"> возможных поведений программы.
\item Вывести такое описание из текста программы.
\item Доказать, что пучок всевозможных фактических поведений программы есть подмножество пучка поведений, допускаемых спецификацией.
\end{itemize}
\end{slide}
